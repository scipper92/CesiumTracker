...
// Knockout library.
            ...
            while (!polygon.isInside(sat)) {
                ...
                if (polygon.isForNorth(sat)) {
                    ...
                    if(westWidth>=2*orbDelta){
                        ...
                        while (!(pl1.near || pl2.near || pr1.near || pr2.near)) {
                        ...
                        if (pr1.d < pl2.d) {
                            t = pl1.near ? t + pl1.d*period : (pr1.near ? t + pr1.d*period : (pl2.near ? t1 + pl2.d*period : t1 + pr2.d*period));
                        } else {
    ...
    function prep4point(startD,endD,milistep,satrec,point,inclination,roll,orbDelta,period,minSun,postObj){
        var t = startD.getTime();
        endD = endD.getTime();
        var now;
    ...
    $("#prepogate").click(function(e){
       ...
       // console.log(orbDelta);
        if(!polygon.isPoint) {
            ...
            prep4point(startD, endD, milistep, satrec, polygon, inclination, roll, orbDelta, period, minSun, postObj);
        }
